...
import EditorQuestion from '~/components/Editor/EditorQuestion';
...
function MakeSlideLayout({ children }) {
    ...
    const { items, selectedElements, getSelectedPreviewItem } = useStore();
    const selectedSlideItem = getSelectedPreviewItem();
